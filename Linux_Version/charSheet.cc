...
int eraseScrolls();
int writeScrolls(characterInfo player, int scrollNum);
...
//have higher saves
                                    ...
                                    extracting.close();
                                    writeScrolls(player, player.scrollCount);
...
int writeScrolls(characterInfo player, int scrollNum){
    ofstream data;
    data.open("Data/Scrolls/scrollNames.txt", std::fstream::app);
    data << player.scrollName[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollDescriptionDamages.txt", std::fstream::app);
    data << player.scrollDescriptionDamage[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollDescriptionActives.txt", std::fstream::app);
    data << player.scrollDescriptionActive[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollDiceTypes.txt", std::fstream::app);
    data << player.scrollDiceType[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollDiceCounts.txt", std::fstream::app);
    data << player.scrollDiceCount[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollTiers.txt", std::fstream::app);
    data << player.scrollTier[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollRanges.txt", std::fstream::app);
    data << player.scrollRange[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollActions.txt", std::fstream::app);
    data << player.scrollAction[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollStyles.txt", std::fstream::app);
    data << player.scrollStyle[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollExtraDamages.txt", std::fstream::app);
    data << player.scrollExtraDamage[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHaveExtraDamages.txt", std::fstream::app);
    data << player.scrollHaveExtraDamage[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHalfActions.txt", std::fstream::app);
    data << player.scrollHalfAction[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHaveHalfActions.txt", std::fstream::app);
    data << player.scrollHaveHalfAction[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollExtraDies.txt", std::fstream::app);
    data << player.scrollExtraDie[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHaveExtraDies.txt", std::fstream::app);
    data << player.scrollHaveExtraDie[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollExtraRanges.txt", std::fstream::app);
    data << player.scrollExtraRange[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHaveExtraRanges.txt", std::fstream::app);
    data << player.scrollHaveExtraRange[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHigherSaves.txt", std::fstream::app);
    data << player.scrollHigherSave[scrollNum] << endl;
    data.close();
    data.open("Data/Scrolls/scrollHaveHigherSaves.txt", std::fstream::app);
    data << player.scrollHaveHigherSave[scrollNum] << endl;
    data.close();
    return 0;
};
